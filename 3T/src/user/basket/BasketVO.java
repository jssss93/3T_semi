...
public class BasketVO {
	...
	private int BASKET_TOTAL;// 상품 총가격
	...
	public String getBASKET_SELECT() {
		return BASKET_SELECT;
	}
	public void setBASKET_SELECT(String bASKET_SELECT) {
		BASKET_SELECT = bASKET_SELECT;
	}

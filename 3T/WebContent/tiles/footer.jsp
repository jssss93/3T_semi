	...
	<div id="main_footer">
		...
		<div id="footer">
			<div class="xans-element- xans-layout xans-layout-footer ">
				...
				<p class="address">
					<span>회사명: 애즈클로 </span> <span>대표이사: 서홍일,서지우</span> <span>e-mail:
				...
				<a href="#"><img
					...
					src="/web/upload/designfixy/images/pgbanner.jpg" alt="에스크로"
					title="에스크로"></a>
				<p class="copy">copyright © 애즈클로 all right reserved.</p>
			</div>

...
<script type="text/javascript">
	...
	<body>
		...
		<table width="600" border="0" cellspacing="0" cellpadding="0"
			height="120" background="/3T/upload/QA_BG.png">
			<tr>
		...
		<table width="600" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td width="500"><s:property value="resultClass.REV_subject" /></td>
			</tr>
			<tr bgcolor="#777777">
				<td height="1" colspan="2"></td>
			</tr>
			...
			<tr>
				...
				<td><s:property value="resultClass.REV_name" /></td>
			</tr>
			<tr bgcolor="#777777">
				<td height="1" colspan="2"></td>
			</tr>

...
<body>
	...
	<table width="600" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
        	...
        	&nbsp; * <s:property value="resultClass.file_orgname"/>파일이 등록 되어 있습니다. 다시 업로드하면 기존의 파일은 삭제됩니다.
        	</s:if>
        	</td>
        </tr>
        <tr>
        	...
        	<td bgcolor="#FFFFF">
        	<s:textarea name="content" theme="simple" value="■ 개인정보의 수집·이용 목적
서비스 제공 및 계약의 이행, 구매 및 대금결제, 물품배송 또는 청구지 발송, 회원관리 등을 위한 목적
■ 수집하려는 개인정보의 항목
이름, 주소, 연락처 등
■ 개인정보의 보유 및 이용 기간
회사는 개인정보 수집 및 이용목적이 달성된 후에는 예외없이 해당정보를 파기합니다.
#개인정보의 위탁 처리애즈클로는 서비스 향상을 위해 관계법령에 따라 회원의 동의를 얻거나 관련 사항을 공개 또는 고지 후 회원의 개인정보를 외부에 위탁하여 처리하고 있습니다. 애즈클로의 개인정보처리 수탁자와 그 업무의 내용은 다음과 같습니다. - 수탁자 : (주)루나소프트- 위탁 업무 내용 : 카카오 알림톡 발송 업무 직송 등 일부 배송형태에 따라, 전자상거래소비자보호법 제 21조에 의거 협력사에 배송정보가 제공 됩니다." cols="80" rows="10"></s:textarea>
        	</td>
       		<td colspan="2"></td>
        </tr>
        <tr>
        <td colspan="2" bgcolor="#FFFFFF">개인정보 수집 및 이용에 동의하십니까?
        <input type="radio"  name="objChkBox" value="동의">동의</input>
        <input type="radio"  name="objChkBox" value="동의안함">동의안함</input>
        </td>
        </tr>
        <tr bgcolor="#777777">
        	<td height="1" colspan="2"></td>

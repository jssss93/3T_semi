...
<body>
	...
	<div class="w3-content w3-section w3-display-container"
		...
		<s:a href="GoodsView.action?goods_no=1124">
			<img id="myimg2" class="mySlides w3-animate-opacit"
				src="/3T/upload/slide1.PNG" width="1500" height="600">
		</s:a>
		<s:a href="GoodsView.action?goods_no=1123">
			<img id="myimg2" class="mySlides w3-animate-opacit"
				src="/3T/upload/slide2.PNG" width=1500 height=600>
		</s:a>
		<s:a href="GoodsView.action?goods_no=1122">
			<img id="myimg2" class="mySlides w3-animate-opacit"
				src="/3T/upload/slide3.PNG" width=1500 height=600>
		</s:a>
		...
		<tr>
			...
			<s:iterator value="list" status="stat">
				...
				<td width="150" height="400" align="center"><s:a
					...
					</s:a><br> <br> <s:property value="goods_name" /><br>

...
<body>
	...
	<table width="1000" border="0" cellspacing="0" cellpadding="2">
		...
		<s:iterator value="list" status="stat">
			...
			<tr  align="center">
				<td><img src="/3T/image/${BASKET_GOODS_img}.small.jpg"
					width="50"></td>
				...
				<td><s:property value="BASKET_SELECT" /></td>
			</tr>
		...
		<tr bgcolor="#F9F9F9">
			...
			<td align="right" colspan="6">상품구매금액 <s:property value="BASKET_GOODS_AMOUNT" /> +배송비 0 =합계 :<font
				color="#FF0000">KRW <s:property value="BASKET_TOTAL" /></font></td>
		</tr>
		</s:iterator>
		<tr align="left">
	...
	<table width="1000" border="1" cellspacing="0" cellpadding="3">
		<tr bgcolor="#F9F9F9">
			<td align="center" height="60" width="340"><font color="#5D5D5D">총
					주문 금액 </font></td>
			<td align="center" width="340"><font color="#5D5D5D">총 배송비</font></td>
		...
		<tr>
			<td width="340" align="center"><font style="font-weight: bold;"><h3>KRW
						<s:property value="BASKET_TOTAL" /></h3></font></td>
			<td width="340" align="center"><font style="font-weight: bold;"><h3>-
						KRW 0</h3></font></td>
			<td align="center"><font style="font-weight: bold;"
				color="#FF0000"><h3>= KRW <s:property value="BASKET_TOTAL" /></h3></font></td>
		</tr>
		</s:iterator>
	</table>
	<table width="1000" border="0" cellspacing="0" cellpadding="3">
		...
		<tr>
			...
			<td colspan="6" align="right"><input name="Main" type="button"
				value="쇼핑계속하기 ▶"
				onClick="javascript:location.href='BasketMain.action?currentPage=<s:property value="currentPage" />'">
			</td>
		</tr>
		<tr>	
			<td width="30">
